...
/// </summary>
public class ShadedFluentEmoji : AssetBase<ShadedFluentEmoji>
{
    private const int width = 32;
    private const int height = 32;
    private const string folder = "Shaded";
    private const string root = "Comentsys.Assets.FluentEmoji.Shaded.Resources";
